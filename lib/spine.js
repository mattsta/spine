...
(function() {
  ...
  Model = (function(_super) {
    ...
    Model.pull = function(idOrCallback, successCallback, failureCallback) {
      if (typeof idOrCallback === 'function') {
        return this.bind('pull', idOrCallback);
      } else {
        return this.trigger('pull', idOrCallback, successCallback, failureCallback);
      }
    };
